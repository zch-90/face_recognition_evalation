...
feaFile = '../data/sphereface.mat'; % Mat file storing extracted features
configFile = '../config/lfw/blufr_lfw_config.mat'; % configuration file for this evaluation
outDir = '../result/'; % output directory
outMatFile = [outDir, 'result_sphereface_pca.mat']; % output mat file
outLogFile = [outDir, 'result_sphereface_pca.txt']; % output text file
...
pcaDims = 1000;%400; % PCA dimensions.
